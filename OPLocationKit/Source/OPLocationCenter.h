...
@property (nonatomic, assign) BOOL findFoursquareVenues;                        // should we grab foursquare venues once we get a coordinate?
@property (nonatomic, retain, readonly) NSArray *foursquareVenues;              // array of OPFoursquareVenue objects

@property (nonatomic, assign) BOOL geocodeLocation;                             // should we geocode the location once we get a coordinate?
